...
def get_nmr_tensors(
    ...
    **kwargs
    ...
    """
    Defines a workflow for calculating the nuclear magnetic resonance tensors.
    ...
    Args:
        ...
        opt_gaussian_inputs (dict): dictionary of Gaussian input parameters; for example:
            {
            "functional": "HF",
            "basis_set": "6-31G(d)",
        ...
        nmr_gaussian_inputs (dict): dictionary of Gaussian input parameters for the
            NMR step; default parameters will be used if not specified
        solvent_gaussian_inputs (str): Gaussian input parameters corresponding to the
            ...
            gaussian_inputs dictionary for each job (i.e. opt_gaussian_inputs, freq_gaussian_inputs, etc.);
            defaults to None
        solvent_properties (dict): additional input parameters to be used in the NMR calculations and
