...
from infrastructure.lammps.fireworks.standard_fw import AmbertoolsTasks
...
if __name__ == "__main__":
    ...
    working_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "test_files", "esp_to_data")
    # print(working_dir)
...
#                     'Nonbond': [[0.3526418, 2.159538]], # from frcmod.ionsjc_tip3p (2008)
    ...
    sys_ff_dict = {Na_label: Na_param_dict,
    ...
    for i, molecule in enumerate(molecules_without_ff_parameters):
        ...
        tleap_settings = {"mol2_file_path": os.path.join(subdir_path, mol2_filename),
