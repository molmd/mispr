...
from infrastructure.lammps.workflows.base_standard import lammps_data_fws, lammps_run_fws, lammps_workflow
...
if __name__ == "__main__":
    ...
    group_def = "\n".join(["group phen type 1 2 3 4 5 6 7",
                           "group wat type 8 9",
                           "group oh type 10 11",
                           "group na type 12"])
    ...
    compute_def = "\n".join(["compute P phen msd com yes",
    ...
    # run_fws, run_links_dict = lammps_run_fws(recipe=recipe,
    #                                          recipe_settings=recipe_settings,
    #                                          recipe_qadapter=qadapter)

    # print(run_links_dict)
    # for firework in run_fws:
    #     print(firework)

    full_fws, full_links_dict = lammps_workflow(system_species_data=sys_species_data,
