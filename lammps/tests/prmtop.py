...
from fireworks import LaunchPad, Firework, FiretaskBase, FWAction, Workflow, FileWriteTask, explicit_serialize
...
if __name__ == "__main__":
    ...
    working_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)),"test_files","prmtop")
    # print(working_dir)
...
#                     'Nonbond': [[0.3526418, 2.159538]], # from frcmod.ionsjc_tip3p (2008)
    ...
    task1 = ProcessPrmtop(working_dir = working_dir,
